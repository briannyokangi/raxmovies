    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <section className="container mx-auto px-4 py-24">
        <div className="mx-auto max-w-xl rounded-[2rem] bg-slate-900/90 p-10 shadow-2xl shadow-black/40">
          ...
          <p className="mt-3 text-slate-400">Sign up to save favorites and share movie reviews.</p>

          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            <div>
              <label className="text-sm uppercase tracking-[0.25em] text-slate-400">Username</label>
              <input
                type="text"
                value={form.username}
            ...
            <button type="submit" className="w-full rounded-full bg-rose-500 px-6 py-4 text-sm font-semibold text-white transition hover:bg-rose-400">Register</button>
          </form>
        </div>
      </section>
    </main>
